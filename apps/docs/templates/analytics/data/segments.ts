...
export const segments: Segment[] = [
  {
    ...
    clauses: [
      {
        kind: "behavior",
        field: "event_count(any)",
        operator: ">=",
        value: "10",
        label: "Performed any event ≥ 10 times"
      },
      {
        kind: "frequency",
        field: "window",
      ...
      },
      {
        ...
        label: "Plan is Growth or Enterprise"
      }
    ]
  },
  {
    ...
    clauses: [
      ...
      {
        kind: "property",
        field: "trial_age_days",
        operator: ">=",
        value: "7",
        label: "Trial age ≥ 7 days"
      },
      {
        kind: "behavior",
        field: "event_count(checkout.completed)",
        operator: "=",
        value: "0",
        label: "Has not completed checkout"
      }
    ]
  },
  {
    ...
    clauses: [
      ...
      {
        kind: "behavior",
        field: "previous_event_count",
        operator: ">=",
        value: "100",
        label: "Previously performed ≥ 100 events"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    clauses: [
      {
        kind: "behavior",
        field: "event(cart.add).property(value)",
        operator: ">=",
        value: "$200",
        label: "Added cart with value ≥ $200"
      },
      {
        kind: "behavior",
        field: "event_count(checkout.completed)",
        operator: "=",
        value: "0",
        label: "Did not complete checkout"
      },
      {
        kind: "frequency",
        field: "window",
