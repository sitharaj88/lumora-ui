...
export const issues: Issue[] = [
  // Backlog
  {
    id: "i-101",
    key: "LMR-142",
    title: "Audit log streaming to S3 sink",
    type: "feature",
    status: "backlog",
    priority: "medium",
    assigneeId: "mk",
  ...
  },
  {
    id: "i-102",
    key: "LMR-143",
    title: "Per-tenant theming UI in admin",
    type: "feature",
    status: "backlog",
    priority: "high",
    assigneeId: "al",
    points: 13,
    labelIds: ["design", "ui", "v0.4"],
    epicId: "ep-themes",
    sprintId: null,
    due: "2026-06-15",
    comments: 7,
  ...
  },
  {
    id: "i-103",
    key: "LMR-144",
    title: "Webhook exponential-backoff retry",
    type: "feature",
    status: "backlog",
    priority: "low",
    assigneeId: "sp",
    ...
    due: null,
    comments: 1,
    updatedRelative: "5d ago"
  },
  {
    id: "i-104",
    key: "LMR-145",
    title: "RTL audit on overlay components",
    type: "chore",
    status: "backlog",
    priority: "medium",
    assigneeId: "rs",
  ...
  },
  {
    ...
    due: null,
    comments: 0,
    updatedRelative: "1w ago"
  },
  {
    id: "i-106",
    key: "LMR-147",
    title: "CLI: `lumora init` scaffolder",
    type: "feature",
    status: "backlog",
    priority: "medium",
    assigneeId: "jh",
  ...
  },
  {
    id: "i-107",
    key: "LMR-148",
    title: "Skeleton width-jitter polish",
    type: "chore",
    status: "backlog",
    priority: "low",
    assigneeId: "rs",
  ...
  },
  {
    id: "i-111",
    key: "LMR-151",
    title: "Date-picker calendar with range",
    type: "feature",
    status: "todo",
    priority: "high",
    assigneeId: "al",
  ...
  // In progress
  {
    ...
    due: "2026-04-28",
    comments: 5,
    updatedRelative: "1h ago"
  },
  {
    id: "i-121",
    key: "LMR-161",
    title: "Theme runtime swap without reload",
    type: "feature",
    status: "in-progress",
    priority: "urgent",
    assigneeId: "rs",
    ...
    due: "2026-04-29",
    comments: 14,
    updatedRelative: "30m ago"
  },
  {
    id: "i-122",
    key: "LMR-162",
    title: "Memory leak in tooltip portal",
    type: "bug",
    status: "in-progress",
    priority: "urgent",
    assigneeId: "mk",
    ...
    due: "2026-04-26",
    comments: 9,
    updatedRelative: "20m ago"
  },
  // Review
  {
    id: "i-130",
    key: "LMR-170",
    title: "OTP slot animation polish",
    type: "chore",
    status: "review",
    priority: "low",
    assigneeId: "sp",
  ...
  },
  {
    id: "i-131",
    key: "LMR-171",
    title: "Improve focus ring contrast on Aurora theme",
    type: "bug",
    status: "review",
    priority: "high",
    assigneeId: "rs",
  ...
  },
  {
    id: "i-142",
    key: "LMR-182",
    title: "Dropdown w/ arrow + sections",
    type: "feature",
    status: "done",
    priority: "medium",
    assigneeId: "rs",
...
export const statusMeta: Record<IssueStatus, { label: string; tone: string; color: string }> = {
...
export const priorityMeta: Record<IssuePriority, { label: string; symbol: string; tone: string }> =
  {
